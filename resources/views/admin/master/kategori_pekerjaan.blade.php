                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="#" class="btn btn-primary btn-add">
                            <i class="fa fa-plus">Tambah Kategori Pekerjaan</i>
                        </a>
                    </div>
                    <div class="card-body">
...
<form class="d-none" method="post" action="{{route("admin.master.kategori_pekerjaan.destroy")}}" id="frmDestroy">
    @csrf
    <input type="hidden" name="id"/>
</form>
@endsection
        ...
        $(document).ready(function() {
            ...
            $(document).on("submit","#frmStore",function(e){
                ...
                if(confirm("Apakah anda yakin ingin menyimpan data ini ? ")){
                    $.ajax({
                        url : '{{route('admin.master.kategori_pekerjaan.store')}}',
                        method : "POST",
                        ...
                        success : function(resp){
                            if(resp.IsError == true){
                                ...
                                swal_success(
                                    resp.Message,
                                    '{{route('admin.master.kategori_pekerjaan.index')}}'
                                );
                            }
                        },
                        error : function(){
            ...
            $(document).on("submit","#frmUpdate",function(e){
                ...
                if(confirm("Apakah anda yakin ingin menyimpan data ini ? ")){
                    $.ajax({
                        url : '{{route('admin.master.kategori_pekerjaan.update')}}',
                        method : "POST",
