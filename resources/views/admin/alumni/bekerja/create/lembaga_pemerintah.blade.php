                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pns" value="1">
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pns" value="0">
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pppk" value="1">
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pppk" value="0">
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
