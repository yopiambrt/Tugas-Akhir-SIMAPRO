                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pns" value="1" @if($result && $result->pns == \App\Models\Alumni\AlumniBekerja::PNS_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pns" value="0" @if($result && $result->pns == \App\Models\Alumni\AlumniBekerja::PNS_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pppk" value="1" @if($result && $result->pppk == \App\Models\Alumni\AlumniBekerja::PPPK_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pppk" value="0" @if($result && $result->pppk == \App\Models\Alumni\AlumniBekerja::PPPK_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on("submit","#frmStore",function(e){
                ...
                if(confirm("Apakah anda yakin ingin menyimpan data ini ? ")){
                    $.ajax({
                        url : '{{route('admin.alumni.bekerja.store_lembaga_pemerintah')}}',
                        method : "POST",
