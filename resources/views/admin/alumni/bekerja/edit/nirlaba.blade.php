                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="yayasan" value="1" @if($result && $result->yayasan == \App\Models\Alumni\AlumniBekerja::YAYASAN_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="yayasan" value="0" @if($result && $result->yayasan == \App\Models\Alumni\AlumniBekerja::YAYASAN_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pbh" value="1" @if($result && $result->pbh == \App\Models\Alumni\AlumniBekerja::PBH_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pbh" value="0" @if($result && $result->pbh == \App\Models\Alumni\AlumniBekerja::PBH_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="lsm" value="1" @if($result && $result->lsm == \App\Models\Alumni\AlumniBekerja::LSM_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="lsm" value="0" @if($result && $result->lsm == \App\Models\Alumni\AlumniBekerja::LSM_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on("submit","#frmStore",function(e){
                ...
                if(confirm("Apakah anda yakin ingin menyimpan data ini ? ")){
                    $.ajax({
                        url : '{{route('admin.alumni.bekerja.update_nirlaba')}}',
                        method : "POST",
