                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="siup" value="1" @if($result && $result->siup == \App\Models\Alumni\AlumniBekerja::SIUP_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="siup" value="0" @if($result && $result->siup == \App\Models\Alumni\AlumniBekerja::SIUP_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on("submit","#frmStore",function(e){
                ...
                if(confirm("Apakah anda yakin ingin menyimpan data ini ? ")){
                    $.ajax({
                        url : '{{route('admin.alumni.bekerja.update_swasta')}}',
                        method : "POST",
