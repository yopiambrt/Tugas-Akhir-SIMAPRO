                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-warning btn-sm btn-edit" data-id="{{$item->id}}" data-name="{{$item->name}}" data-email="{{$item->email}}" data-role="{{$item->is_admin}}"><i class="fa fa-edit"></i></a>
...
<form class="d-none" method="post" action="{{route("admin.user.active")}}" id="frmActive">
    @csrf
    <input type="hidden" name="id"/>
</form>
<form class="d-none" method="post" action="{{route("admin.user.banned")}}" id="frmBanned">
    @csrf
    <input type="hidden" name="id"/>
</form>
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click",".btn-edit",function(){
                ...
                $("#frmUpdate").find('select[name="is_admin"]').val(role).change();
