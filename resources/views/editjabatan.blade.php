                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <form class="theme-form" action="/edit/jabatan/{{$datajabatanrinci->id}}" method="post">
                          <div class="mb-3">
                          @csrf
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Jabatan Pekerjaan</label>
                            <input class="form-control" id="exampleInputEmail1" type="text" name="jabatan" value="{{$datajabatanrinci->jabatan}}">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Golongan</label>
                            <input class="form-control" id="exampleInputEmail1" type="text" name="golongan" value="{{$datajabatanrinci->golongan}}">
                          </div>
