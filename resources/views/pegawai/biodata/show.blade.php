                                        ...
                                        <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <div class="row mt-5">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Pendidikan Terakhir</label>
                                                        <input type="text" class="form-control" name="ayah_pendidikan_terakhir" placeholder="Pendidikan Terakhir" value="{{$result->keluarga->ayah_pendidikan_terakhir ?? null}}"/>
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Pendidikan Terakhir</label>
                                                        <input type="text" class="form-control" name="ibu_pendidikan_terakhir" placeholder="Pendidikan Terakhir" value="{{$result->keluarga->ibu_pendidikan_terakhir ?? null}}"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pekerjaan</label>
