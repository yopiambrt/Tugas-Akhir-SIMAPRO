                                    ...
                                    @if ($item->user_id == Auth::user()->id)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('mhs.prestasi.delete', $item->id) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('mhs.prestasi.store') }}" method="post">
                        @csrf
                        <div class="form-group"><label for="">Nama</label>
                            <input type="text" name="user_id" value="{{ Auth::user()->name }}" disabled
                                class="form-control">
                        </div>
        ...
        <div class="modal fade" id="exampleModal-{{ $usr->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('mhs.prestasi.update', $usr->id) }}" method="post">
                            @csrf
                            @method('patch')
                            <div class="form-group"><label for="">Nama</label>
                                <input type="text" name="user_id" value="{{ Auth::user()->name }}" disabled
