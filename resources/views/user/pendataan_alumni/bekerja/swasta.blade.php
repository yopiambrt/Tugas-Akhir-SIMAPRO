                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group text-center">
                                        <label>Instansi Memiliki SIUP / IUMK ? </label>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="siup" value="1" @if($result->alumni_bekerja && $result->alumni_bekerja->siup == \App\Models\Alumni\AlumniBekerja::SIUP_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="siup" value="0" @if($result->alumni_bekerja && $result->alumni_bekerja->siup == \App\Models\Alumni\AlumniBekerja::SIUP_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on("submit","#frmStore",function(e){
                ...
                if(confirm("Apakah anda yakin ingin menyimpan data ini ? ")){
                    $.ajax({
                        url : '{{route('mhs.pendataan_alumni.bekerja.store_swasta')}}',
                        method : "POST",
