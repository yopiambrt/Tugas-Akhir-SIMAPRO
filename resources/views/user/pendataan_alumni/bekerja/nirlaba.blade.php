                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pkwt" value="1" @if($result->alumni_bekerja && $result->alumni_bekerja->pkwt == \App\Models\Alumni\AlumniBekerja::PKWT_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pkwt" value="0" @if($result->alumni_bekerja && $result->alumni_bekerja->pkwt == \App\Models\Alumni\AlumniBekerja::PKWT_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pkwtt" value="1" @if($result->alumni_bekerja && $result->alumni_bekerja->pkwtt == \App\Models\Alumni\AlumniBekerja::PKWTT_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pkwtt" value="0" @if($result->alumni_bekerja && $result->alumni_bekerja->pkwtt == \App\Models\Alumni\AlumniBekerja::PKWTT_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        <label>Instansi Merupakan Yayasan ? </label>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="yayasan" value="1" @if($result->alumni_bekerja && $result->alumni_bekerja->yayasan == \App\Models\Alumni\AlumniBekerja::YAYASAN_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="yayasan" value="0" @if($result->alumni_bekerja && $result->alumni_bekerja->yayasan == \App\Models\Alumni\AlumniBekerja::YAYASAN_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        <label>Instansi Merupakan Perkumpulan Berbadan Hukum (PBH) ? </label>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pbh" value="1" @if($result->alumni_bekerja && $result->alumni_bekerja->pbh == \App\Models\Alumni\AlumniBekerja::PBH_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="pbh" value="0" @if($result->alumni_bekerja && $result->alumni_bekerja->pbh == \App\Models\Alumni\AlumniBekerja::PBH_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        <label>Instansi Merupakan Lembaga Swadaya Masyarakt (LSM) ? </label>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="lsm" value="1" @if($result->alumni_bekerja && $result->alumni_bekerja->lsm == \App\Models\Alumni\AlumniBekerja::LSM_YES) checked @endif>
                                                <label class="form-check-label" >
                                                Ya
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input class="form-check-input" type="radio" name="lsm" value="0" @if($result->alumni_bekerja && $result->alumni_bekerja->lsm == \App\Models\Alumni\AlumniBekerja::LSM_NO) checked @endif>
                                                <label class="form-check-label" >
                                                Tidak
                                                </label>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on("submit","#frmStore",function(e){
                ...
                if(confirm("Apakah anda yakin ingin menyimpan data ini ? ")){
                    $.ajax({
                        url : '{{route('mhs.pendataan_alumni.bekerja.store_nirlaba')}}',
                        method : "POST",
