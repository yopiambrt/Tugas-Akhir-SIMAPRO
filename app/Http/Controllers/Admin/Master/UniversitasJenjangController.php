...
class UniversitasJenjangController extends Controller
{
    /**
    ...
    public function __construct(){
        $this->view = "admin.master.universitas_jenjang";
        $this->route = "admin.master.universitas_jenjang.";
        $this->universitas_jenjang = new UniversitasJenjang();
    }
    public function index()
    {
        $table = $this->universitas_jenjang;
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $this->universitas_jenjang->create([
                'nama' => $nama,
            ]);
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $result = $this->universitas_jenjang;
