...
class UniversitasLevelController extends Controller
{
    /**
    ...
    public function __construct(){
        $this->view = "admin.master.universitas_level";
        $this->route = "admin.master.universitas_level.";
        $this->universitas_level = new UniversitasLevel();
    }
    public function index()
    {
        $table = $this->universitas_level;
