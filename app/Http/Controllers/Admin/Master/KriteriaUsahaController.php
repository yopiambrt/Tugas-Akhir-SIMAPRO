...
class KriteriaUsahaController extends Controller
{
    /**
    ...
    public function __construct(){
        $this->view = "admin.master.kriteria_usaha";
        $this->route = "admin.master.kriteria_usaha.";
        $this->kriteria_usaha = new KriteriaUsaha();
    }
    public function index()
    {
        $table = $this->kriteria_usaha;
