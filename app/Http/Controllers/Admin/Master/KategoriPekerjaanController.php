...
class KategoriPekerjaanController extends Controller
{
    ...
    public function __construct(){
        $this->view = "admin.master.kategori_pekerjaan";
        $this->route = "admin.master.kategori_pekerjaan.";
        $this->kategori_pekerjaan = new KategoriPekerjaan();
    }
    public function index()
    {
        $table = $this->kategori_pekerjaan;
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $this->kategori_pekerjaan->create([
                'nama' => $nama,
            ]);
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $result = $this->kategori_pekerjaan;
