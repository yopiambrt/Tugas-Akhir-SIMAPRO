...
class LevelInstansiController extends Controller
{
    /**
    ...
    public function __construct(){
        $this->view = "admin.master.level_instansi";
        $this->route = "admin.master.level_instansi.";
        $this->level_instansi = new LevelInstansi();
    }
    public function index()
    {
        $table = $this->level_instansi;
