...
class LevelUsahaController extends Controller
{
    /**
    ...
    public function __construct(){
        $this->view = "admin.master.level_usaha";
        $this->route = "admin.master.level_usaha.";
        $this->level_usaha = new LevelUsaha();
    }
    public function index()
    {
        $table = $this->level_usaha;
