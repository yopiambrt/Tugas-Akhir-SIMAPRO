...
class BiodataController extends Controller
{
    ...
    public function __construct(){
        $this->view = "pegawai.biodata.";
        $this->route = "pegawai.biodata.";
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $ayah_pendidikan_terakhir = (empty($request->input("ayah_pendidikan_terakhir"))) ? null : trim(htmlentities($request->input("ayah_pendidikan_terakhir")));
            ...
            $ibu_pendidikan_terakhir = (empty($request->input("ibu_pendidikan_terakhir"))) ? null : trim(htmlentities($request->input("ibu_pendidikan_terakhir")));
            ...
            $this->data_keluarga->updateOrCreate([
                ...
                'ayah_pendidikan_terakhir' => $ayah_pendidikan_terakhir,
                'ayah_pekerjaan' => $ayah_pekerjaan,
                'ayah_gaji' => $ayah_gaji,
                'ibu_nama' => $ibu_nama,
                'ibu_alamat' => $ibu_alamat,
                'ibu_telepon' => $ibu_telepon,
                'ibu_pendidikan_terakhir' => $ibu_pendidikan_terakhir,
