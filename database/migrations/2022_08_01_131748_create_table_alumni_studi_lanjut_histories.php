...
class CreateTableAlumniStudiLanjutHistories extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('alumni_studi_lanjut_histories', function (Blueprint $table) {
            $table->id();
            $table->string("nama");
    ...
    {
        Schema::dropIfExists('alumni_studi_lanjut_histories');
    }
}
