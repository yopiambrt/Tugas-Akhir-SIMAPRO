...
class CreateTableAlumniWirausahaHistories extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('alumni_wirausaha_histories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('alumni_wirausaha_histories');
    }
}
